...
export const developerSdkCatalog = () => [
  {
    ...
    description: 'Typed client and CLI for payment intents, PaySafe actions, webhook verification, and replay.',
  },
  {
    id: 'php-sdk',
    language: 'PHP',
    status: 'planned',
    packageName: 'orbi/pay-gateway',
    docsPath: '/docs/PLATFORM_INTEGRATION_CONTRACTS.md',
    description: 'Merchant checkout and webhook verification helpers for PHP commerce stacks.',
  },
  {
    id: 'python-sdk',
    language: 'Python',
    ...
    packageName: 'orbi-pay-gateway',
    docsPath: '/docs/PLATFORM_INTEGRATION_CONTRACTS.md',
    description: 'Server-side integrations for SACCOS, organizations, and custom back offices.',
  },
  {
    id: 'openapi-spec',
    language: 'OpenAPI',
